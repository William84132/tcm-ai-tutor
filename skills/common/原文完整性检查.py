...
def check_medical_cases():
    ...
    cases = [
        ...
        ("王孟英医案绎注", "医案类", "王孟英医案绎注_字符还原版.txt", 100),
        ("临证指南医案", "医案类", "临证指南医案.txt", 100),
        ("吴鞠通医案", "医案类", "吴鞠通医案_字符还原版.txt", 100),
        ("吴佩衡医案", "医案类", "吴佩衡医案.txt", 50),
        ("洄溪医案", "医案类", "洄溪医案（徐灵胎）.txt", 20),
...
def check_lectures():
    """检查核心原文主文本（现代医家讲稿已按版权合规移除，改查公有领域主文本）"""
    lectures = [
        ("素问王冰注本校对版", "黄帝内经类", "重广补注黄帝内经素问（王冰注）_校对.txt", 300),
        ("灵枢经", "黄帝内经类", "灵枢经.txt", 100),
    ]
